...
/// <summary>
///	Definição do nome do NPC do cenário de login.</summary>
#define NPC_LOGIN_SCENARIO_NAME "NPC_LOGIN_CENARIO"

const

	/// <summary>
	///	Definições do cenário de login.</summary>
	SCENARIO_WEATHER		= 78,
	NPC_LOGIN_SCENARIO_SKIN	= 171,
	LOGIN_VIRTUAL_WORLD 	= 99,

	/// <summary>
	///	Definição da cor do seletor do cursor.</summary>
	LOGIN_MENU_SELECTOR_COLOR = (0x757575FF),

	/// <summary>
	///	Definição do clima/skin do lobby.</summary>
	LOBBY_WEATHER 		= 78,
	PLAYER_LOBBY_SKIN	= 171,

	/// <summary>
	///	Definições de limites.</summary>
	MAX_PASSWORD_SIZE	= 20,
	MAX_EMAIL_SIZE		= 64,
	MAX_LOGIN_ATTEMPTS	= 3,

	/// <summary>
	///	Definição do tempo para enviar email novamente em segundos.</summary>
	RESEND_MAIL_TIME	= 30,

	/// <summary>
	///	Definições das páginas do menu de login.</summary>
	MENU_NONE				= -1,
	MENU_HOME				= 0,
	MENU_LOGIN				= 1,
	MENU_REGISTER			= 2,
	...
	/// <summary>
	///	Definições dos dialogs id.</summary>
 ...
 */
/// <summary>
///	Enumerador da variável 'textGlobalLoginScreen[E_TEXT_GLOBAL_LOGIN_SCREEN]'.</summary>
...
/// <summary>
///	Enumerador da variável 'textGlobalMenu[E_TEXT_GLOBAL_MENU]'.</summary>
...
/// <summary>
///	Enumerador da variável 'textPrivateMenu[MAX_PLAYERS][E_TEXT_PRIVATE_MENU]'.</summary>
...
/// <summary>
///	Enumerador da variável 'npcLoginScenario[E_NPC_LOGIN_SCENARIO]'.</summary>
...
/// <summary>
///	Enumerador da variável 'playerMenuLoginControl[MAX_PLAYERS][E_PLAYER_MENU_LOGIN_CONTROL]'.</summary>
...
/// <summary>
///	Enumerador da variável 'playerDataTemp[MAX_PLAYERS][E_PLAYER_DATA_TEMP]'.</summary>
...
/// <summary>
///	Enumerador da variável 'lobbyPosition[E_LOBBY_POSITION]'.</summary>
...
/// <summary>
///	Enumerador da variável 'playerLobbyControl[MAX_PLAYERS][E_PLAYER_LOBBY_CONTROL]'.</summary>
...
/// <summary>
///	Enumerador das variáveis que armazenam posição X, Y, Z e ROT.</summary>
enum E_POSITIONS
{
	Float:E_POSITION_X,
	Float:E_POSITION_Y,
...
/// <summary>
///	Enumerador das variáveis que armazenam posição X, Y, Z da câmera.</summary>
...
new const
	...
	/// <summary>
	///	Posição do jogador na tela de login.</summary>
	Float:loginScreenPosition[E_POSITIONS] = {319.4734, 8829.8604, 12.9612, 0.0},

	/// <summary>
	///	Posição da camera na tela de login.</summary>
...
static
	...
	/// <summary>
	///	Variáveis para armazenar as textdraws globais e privadas.</summary>
	...
	/// <summary>
	///	Variável para controlar se o jogador está na tela de login.</summary>
	bool:playerInLoginScreen[MAX_PLAYERS],

	/// <summary>
	///	Variável para controles da tela de login do jogador.</summary>
	playerMenuLoginControl[MAX_PLAYERS][E_PLAYER_MENU_LOGIN_CONTROL],

	/// <summary>
	///	Variável para controles do lobby do jogador.</summary>
	playerLobbyControl[MAX_PLAYERS][E_PLAYER_LOBBY_CONTROL],

	/// <summary>
	///	Variável para armazenar dados temporários do jogador da tela de login.</summary>
	playerDataTemp[MAX_PLAYERS][E_PLAYER_DATA_TEMP],

	/// <summary>
	///	Variável para armazenar dados e controlar o NPC do cenário.</summary>
...
public OnGameModeInit()
{
	...
	///		> cria o NPC do cenário de login;
...
public OnPlayerConnect(playerid)
{
	...
	///		> faz o controle das variáveis do jogador;
...
public OnPlayerDisconnect(playerid, reason)
{
	...
	/// Nesta callback:
	///		> se o jogador for NPC: retorna 1;
	///		> se o jogador estiver no menu de código de verificação:
	///			|> destrói as textdraws do menu.
	///		> se o jogador estiver na tela de login:
	///			|> faz o controle de jogadores assistindo o NPC do cenário.
	/// </summary>
...
public OnPlayerSpawn(playerid)
{
	...
	///		> se o jogador for NPC: retorna 1;
	///		> se o jogador estiver na tela de login:
	///			|> seta o jogador na posição da tela de login e mostra o menu.
	/// </summary>
...
public OnPlayerRequestClass(playerid, classid)
{
	...
	///			|> retorna 1.
	///		> se o jogador estiver na tela de login:
	///			|> congela a câmera de espectador do jogador.
	///		> se o jogador não estiver morto:
	///			|> spawna o jogador.
	/// </summary>
...
public OnPlayerClickTextDraw(playerid, Text:clickedid)
{
	...
	/// <summary>
	/// Nesta callback:
	///		> se a textdraw clicada for invalida ou o jogador não estiver no menu de login: retorna 1;
	...
	/// <summary>
	/// Volta à pagina principal ao clicar sobre '<'.
	/// </summary>
	...
	else if(clickedid == textGlobalMenu[E_TEXT_BUTTON_USERNAME_CHANGE])//alterar username
	{
		...
		if(playerMenuLoginControl[playerid][E_PLAYER_IN_MENU] != MENU_LOGIN)
			ShowPlayerDialogFormat(playerid, DIALOG_MENU_CHANGE_USERNAME, DIALOG_STYLE_INPUT, dlg_change_name_sing_in_caption, "Nome atual: {E84F33}%s{BCD2EE}\n\nDeseja registrar sua conta com outro nome? Insira abaixo, de 3 a 20 caracteres.\nNa próxima vez que se conectar, deverá utilizar o nome escolhido.", dialog_button_confirm, dialog_button_back, GetNameOfPlayer(playerid));
		else
			ShowPlayerDialogFormat(playerid, DIALOG_MENU_CHANGE_USERNAME, DIALOG_STYLE_INPUT, dlg_change_name_login_caption, "Conta de usuário atual: {E84F33}%s{BCD2EE}\n\nDeseja fazer login em outra conta? Insira abaixo\no usuário da conta que deseja logar.", dialog_button_confirm, dialog_button_back, GetNameOfPlayer(playerid));
	}
	
	/// <summary>
	/// Mostra/esconde a senha do jogador ao clicar sobre o botão indicador no campo 'senha'.
	/// </summary>
	...
	else if(clickedid == textGlobalMenu[E_TEXT_LOGIN_BUTTON][1])//recuperar senha
	{
		...
		if(gettime() - playerDataTemp[playerid][E_PLAYER_EMAIL_SENT_TIME] < RESEND_MAIL_TIME)
			return ShowPlayerDialog(playerid, DIALOG_MENU_ONLY_MESSAGE, DIALOG_STYLE_MSGBOX, "Recuperar senha", "Aguarde para usar esta função novamente, um email recém foi enviado para você.", dialog_button_confirm, dialog_button_off);

		ShowPlayerDialog(playerid, DIALOG_MENU_RECOVER_PASSWORD, DIALOG_STYLE_INPUT, "Recuperar senha", "Para recuperar sua senha, insira abaixo o email utilizado na criação de sua conta.", "Próximo", dialog_button_back);
	}
...
public OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid)
{
	...
	/// <summary>
	/// Abre um dialog para inserir o código de verificação ao clicar sobre 'código'.
	/// </summary>
	...
	/// <summary>
	/// Reenvia o email para mandar novamente o código de verificação ao clicar sobre 'reenviar'.
	/// </summary>
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	...
	switch(dialogid)
	{
		...
		case DIALOG_MENU_REGISTER_EMAIL:
		{
			...
			if(!IsValidEmail(inputtext))
			{
				if(playerMenuLoginControl[playerid][E_PLAYER_IN_MENU] == MENU_REGISTER_CODE)
					...
					return ShowPlayerDialog(playerid, DIALOG_MENU_REGISTER_EMAIL, DIALOG_STYLE_INPUT, dialog_insert_email_caption, WARNING_CHAR "Email inválido! Caracteres aceitos: A a Z, 0 a 9, @(arroba), _(underline), .(ponto) e -(hífen).\n\nInsira um email válido, ele será vinculado a sua conta para medidas de\nsegurança e demais funções opcionais. Você poderá alterá-lo futuramente.\n\n{E84F33}OBS{BCD2EE}: Somente se você autorizar administradores poderão visualizar seu email.", dialog_button_confirm, dialog_button_back);
			}
		...
		/// <summary>
		/// Dialog para registrar o código de verificação.
		/// </summary>
		...
		/// <summary>
		/// Dialog de confirmação para cancelar o registro.
		/// </summary>
		...
		case DIALOG_MENU_RECOVER_PASSWORD + 4:
		{
			...
			if(!isnull(inputtext) && !strcmp(inputtext, playerDataTemp[playerid][E_PLAYER_PASSWORD_TEMP], .length = MAX_PASSWORD_SIZE))
			{
				...
				ShowPlayerDialog(playerid, DIALOG_MENU_ONLY_MESSAGE, DIALOG_STYLE_MSGBOX, "Recuperar senha", "Senha alterada com sucesso! Você já pode fazer seu login.", dialog_button_confirm, dialog_button_off);
			}
			else
				ShowPlayerDialog(playerid, DIALOG_MENU_RECOVER_PASSWORD + 5, DIALOG_STYLE_PASSWORD, "Recuperar senha", WARNING_CHAR "As senhas não combinam!\n\nInsira novamente sua senha para confirmar.", dialog_button_confirm, "Opções");
		...
		case DIALOG_MENU_RECOVER_PASSWORD + 6:
		{
			...
			{
				case 0:
					ShowPlayerDialogFormat(playerid, DIALOG_MENU_RECOVER_PASSWORD + 3, DIALOG_STYLE_PASSWORD, "Recuperar senha", "Insira sua nova senha abaixo, de 3 a %d caracteres.", "Próximo", dialog_button_back, MAX_PASSWORD_SIZE);
				case 1:
				{
					format(playerDataTemp[playerid][E_PLAYER_PASSWORD_TEMP], MAX_PASSWORD_SIZE, inputtext);
					SelectTextDraw(playerid, LOGIN_MENU_SELECTOR_COLOR, this);
...
public OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
	...
	///			|> chama função para acessar o menu de seleção de personagens.	
	/// </summary>
 ...
 */
/// <summary>
/// Callback para verificar se o jogador não passou pelas callbacks de downlaod
/// solicitado ou finalizado. As callbacks não são chamadas após o reconnect.
/// </summary>
...
/// <summary>
/// Callback chamada quando o cursor é desativado pelo jogador pela tecla ESC.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
...
/// <summary>
/// Callback resposta da requisição MySQL da função CheckNameAlreadyRegistered
/// para alertar o jogador no registro que o nick já está em uso.
/// Intervalo: -
/// </summary>
/// <param name="playerid">ID do jogador.</param>
...
public CheckNameRegisteredResponse(playerid, name[])
{
	...
	{
		if(playerMenuLoginControl[playerid][E_PLAYER_REGISTERING])
			return ShowPlayerDialogFormat(playerid, DIALOG_MENU_CHANGE_USERNAME, DIALOG_STYLE_INPUT, dlg_change_name_sing_in_caption, WARNING_CHAR "Este nome de usuário já está registrado! Use outro.\n\nNome atual: {E84F33}%s{BCD2EE}\n\nDeseja registrar sua conta com outro nome? Insira abaixo, de 3 a 20 caracteres.\nNa próxima vez que se conectar, deverá utilizar o nome escolhido.", dialog_button_confirm, dialog_button_back, GetNameOfPlayer(playerid));
	}
	else
	{
		if(!playerMenuLoginControl[playerid][E_PLAYER_REGISTERING])
			return ShowPlayerDialogFormat(playerid, DIALOG_MENU_CHANGE_USERNAME, DIALOG_STYLE_INPUT, dlg_change_name_login_caption, WARNING_CHAR "Este nome de usuário não está registrado!\n\nConta de usuário atual: {E84F33}%s{BCD2EE}\n\nDeseja fazer login em outra conta? Insira abaixo\no usuário da conta que deseja logar.", dialog_button_confirm, dialog_button_back, GetNameOfPlayer(playerid));
	}
...
/// <summary>
/// Inicia a animação mágica do NPC do cenário de login.
/// </summary>
/// <returns>Não retorna valores específicos.</returns>
...
/// <summary>
/// Para a animação mágica do NPC do cenário de login.
/// </summary>
/// <returns>Não retorna valores específicos.</returns>
...
-----------------------------------------------------------------------------*/
/// <summary>
/// Reseta todos os controles do login de um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Reseta todos os controles do lobby de um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
-----------------------------------------------------------------------------*/
/// <summary>
/// Carrega o cenário de login para um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores específicos.</returns>
...
-----------------------------------------------------------------------------*/
/// <summary>
/// Abre a tela de login para um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Obtém a skin da conta de um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
...
/// <summary>
/// Posiciona o jogador no cenário da tela de login e mostra as textdraws.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
-----------------------------------------------------------------------------*/
/// <summary>
/// Reproduz uma das soundtracks do servidor para um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
-----------------------------------------------------------------------------*/
/// <summary>
/// Mostra o menu inicial para um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Esconde o menu inicial de um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Mostra o menu de login para um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Esconde o menu de login de um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Mostra o menu de registro para um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Esconde o menu de registro de um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Cria e mostra um menu temporário para inserir código de verificação para um
/// jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Esconde e destrói um menu temporário para inserir código de verificação de um
/// jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
-----------------------------------------------------------------------------*/
/// <summary>
/// Envia um código de recuperação de senha para um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Envia um código de verificação de conta para um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
-----------------------------------------------------------------------------*/
/// <summary>
/// Verifica se um jogador específico está perto do livro indicador para
/// acessar o menu de seleção de personagens.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Carrega o cenário e coloca um jogador específico no menu de seleção de
/// personagens.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Remove um jogador específico do menu de seleção de personagens.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Coloca um jogador específico no lobby.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
-----------------------------------------------------------------------------*/
/// <summary>
/// Funções continuadas após o fade terminar seu efeito.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
 ...
 */
/// <summary>
/// Converte um email específico para texto de textdraw.
/// </summary>
...
/// <summary>
/// Cria uma máscara com caracteres especiais de uma senha específica para
/// texto de textdraw.
/// </summary>
/// <param name="password">Senha.</param>
/// <returns>Senha com máscara suportada em textdraw.</returns>
