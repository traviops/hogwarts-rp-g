...
const
	...
	/// <summary>
	///	Definição do clima do lobby.</summary>
	LOBBY_WEATHER = 78,
...
static
	...
	/// <summary>
	///	Variável para armazenar a gangzone que bloqueia o mapa.</summary>
	mapBlock,
	...
	/// <summary>
	///	Variável para controlar se o jogador morreu.</summary>
...
public OnPlayerClickTextDraw(playerid, Text:clickedid)
{
	...
	else if(clickedid == textGlobalLoginScreen[E_LOGIN_SCREEN_TEXT][2])//sobre
	{
		...
		ShowPlayerDialog(playerid, DIALOG_MENU_ONLY_MESSAGE, DIALOG_STYLE_MSGBOX, DIALOG_BTN_ABOUT_CAPTION, DIALOG_BTN_ABOUT_INFO, DIALOG_BUTTON_CLOSE, "");
	}
	...
	else if(clickedid == textGlobalMenu[E_TEXT_REGISTER_BUTTON][1])//termos
	{
		...
		ShowPlayerDialog(playerid, DIALOG_MENU_ONLY_MESSAGE, DIALOG_STYLE_MSGBOX, DIALOG_TEMRS_CAPTION, DIALOG_TEMRS_INFO, DIALOG_BUTTON_CLOSE, "");
	}
...
/// <summary>
/// Cria todas as textdraws privadas do menu de login.
/// </summary>
/// <returns>Não retorna valores.</returns>
...
static PositionPlayerLoginScreen(playerid)
{
	...
	SelectTextDraw(playerid, LOGIN_MENU_SELECTOR_COLOR/*0xDDDDDDAA*/, this);

	LoadPlayerLoginScenario(playerid);

	defer SetPlayerFade[3000](playerid, FADE_TYPE_OUT, 50, MODULE_LOGIN, FADE_WAITING_LOGIN_SCREEN);
}
/*
-----------------------------------------------------------------------------*/
/// <summary>
...
static PutPlayerInCharacterMenu(playerid)
{
	...
	defer SetPlayerFade[500](playerid, FADE_TYPE_OUT, 50, MODULE_LOGIN, FADE_WAITING_MENU_CHARACTER);
}
...
static PutPlayerInLobby(playerid)
{
	...
	defer SetPlayerFade[500](playerid, FADE_TYPE_OUT, 50, MODULE_LOGIN, FADE_WAITING_LOGIN_SCREEN);
}
/*
-----------------------------------------------------------------------------*/
/// <summary>
		...
		switch(fadeWaitingType)
		{
			...
			case FADE_WAITING_OUT_MENU_CHARACTER:
			{
				if(playerLobbyControl[playerid][E_PLAYER_IN_MENU_CHARACTER])
				{
					...
					defer SetPlayerFade[500](playerid, FADE_TYPE_OUT, 50, MODULE_LOGIN, FADE_WAITING_OUT_MENU_CHARACTER);
				}
			}
		}
	}
