...
static
	...
	playerFadeWaitingFor[MAX_PLAYERS],
...
public OnPlayerConnect(playerid)
{
	...
	playerFadeWaitingFor[playerid] = FADE_WAITING_LOGIN_SCREEN;
...
public OnFadeScreenPlayerChanged(playerid, bool:fadeType)
{
	...
	{
		switch(playerFadeWaitingFor[playerid])
		{
			...
			case FADE_WAITING_OUT_MENU_CHARACTER:
			{
				if(playerLobbyControl[playerid][E_PLAYER_IN_MENU_CHARACTER])
				{
					...
					playerFadeWaitingFor[playerid] = FADE_WAITING_NONE;
...
PlayerCharacterMenu(playerid)
{
	if(playerFadeWaitingFor[playerid] == FADE_WAITING_MENU_CHARACTER ||
	...
	if(IsPlayerInRangeOfPoint(playerid, 1.0, positionEnterCharacterMenu[E_POSITION_X], positionEnterCharacterMenu[E_POSITION_Y], positionEnterCharacterMenu[E_POSITION_Z]))
	{
		...
		playerFadeWaitingFor[playerid] = FADE_WAITING_MENU_CHARACTER;
...
RemovePlayerCharacterMenu(playerid)
{
	...
	playerFadeWaitingFor[playerid] = FADE_WAITING_OUT_MENU_CHARACTER;
