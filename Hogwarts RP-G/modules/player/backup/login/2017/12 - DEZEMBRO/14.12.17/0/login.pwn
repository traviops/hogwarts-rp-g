...
/*
/// <summary>
///	Enumerador da variável 'var'.</summary>
...
public OnPlayerDisconnect(playerid, reason)
{
	...
	/// Nesta callback:
	///		> se o jogador for NPC: retorna 1;
	///		> se o jogador estiver no menu de código de ativação:
...
public OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid)
{
	...
	/// <summary>
	/// Abre um dialog para inserir o código de ativação ao clicar sobre 'código'.
	/// </summary>
	...
	/// <summary>
	/// Reenvia o email para mandar novamente o código de ativação ao clicar sobre 'reenviar'.
	/// </summary>
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	...
	switch(dialogid)
	{
		...
		/// <summary>
		/// Dialog para registrar o código de ativação.
		/// </summary>
...
/// <summary>
/// Cria e mostra um menu temporário para inserir código de ativação para um
/// jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Esconde e destrói um menu temporário para inserir código de ativação de um
/// jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Envia um código de ativação de conta para um jogador específico.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <returns>Não retorna valores.</returns>
