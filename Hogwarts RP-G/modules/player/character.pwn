...
static
	...
	/// <summary> 
	///	Variável dos atores criados para o jogador.</summary>
...
/// <summary>
/// Obtém o index da matriz attachCharsFeatureHairs de uma skin específica.
/// </summary>
/// <param name="skinid">ID da skin.</param>
/// <returns>Index da matriz. FEATURE_TYPE_INVALID se nada for encontrado.</returns>
...
-----------------------------------------------------------------------------*/
/// <summary>
/// Atualiza a informação 'gênero' do menu de criação de personagem.
/// Se 'isChangedByPlayer' for true, seta a primeira skin do gênero alterado e
/// remove as características cabelo e olho se estiverem setadas.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <param name="genderid">Tipo do gênero (GENDER_TYPE_MALE | GENDER_TYPE_FEMALE).</param>
/// <param name="isChangedByPlayer">True se a alteração do gênero foi feita pelo jogador, False se não.</param>
/// <returns>Não retorna valores.</returns>
...
/// <summary>
/// Aplica as funções da característica selecionada no menu de criação de personagens.
/// As funções podem ser avançar/voltar característica ou selecionar.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
...
/// <summary>
/// Atualiza uma característica específica no menu de criação de personagens.
/// </summary>
/// <param name="playerid">ID do jogador.</param>
/// <param name="featureType">Tipo da característica.</param>
/// <param name="featureValue">Valor da característica.</param>
/// <returns>True se a característica for alterada, False se for removida ou ocorrer algum erro.</returns>
